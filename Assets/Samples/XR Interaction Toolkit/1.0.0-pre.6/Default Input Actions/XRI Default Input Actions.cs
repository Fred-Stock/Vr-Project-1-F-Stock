...
public class @XRIDefaultInputActions : IInputActionCollection, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""RotateBallista"",
                    ""type"": ""Value"",
                    ""id"": ""6f2b2df2-d483-41a5-a96b-ff0ec27a1c9c"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""5be75994-3bd7-4ba6-b5dd-eb9b5f2b9f6b"",
                    ""path"": ""<XRController>{LeftHand}/thumbstick"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""RotateBallista"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""RotateBallista"",
                    ""type"": ""Value"",
                    ""id"": ""ef77eede-3a08-4b3d-b8d7-f7a877a8f655"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""a220cc46-90a7-4f46-913a-3a71f78cdd68"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_RotateBallista = m_XRILeftHand.FindAction("RotateBallista", throwIfNotFound: true);
        // XRI RightHand
        ...
        m_XRIRightHand_RotateBallista = m_XRIRightHand.FindAction("RotateBallista", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_XRILeftHand_RotateBallista;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @RotateBallista => m_Wrapper.m_XRILeftHand_RotateBallista;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @RotateBallista.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnRotateBallista;
                @RotateBallista.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnRotateBallista;
                @RotateBallista.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnRotateBallista;
            }
            ...
            if (instance != null)
            {
                ...
                @RotateBallista.started += instance.OnRotateBallista;
                @RotateBallista.performed += instance.OnRotateBallista;
                @RotateBallista.canceled += instance.OnRotateBallista;
            }
        }
    }
    ...
    private readonly InputAction m_XRIRightHand_RotateBallista;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @RotateBallista => m_Wrapper.m_XRIRightHand_RotateBallista;
        ...
        public void SetCallbacks(IXRIRightHandActions instance)
        {
            if (m_Wrapper.m_XRIRightHandActionsCallbackInterface != null)
            {
                ...
                @RotateBallista.started -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRotateBallista;
                @RotateBallista.performed -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRotateBallista;
                @RotateBallista.canceled -= m_Wrapper.m_XRIRightHandActionsCallbackInterface.OnRotateBallista;
            }
    ...
    public interface IXRILeftHandActions
    {
        ...
        void OnRotateBallista(InputAction.CallbackContext context);
    }
